...
WEBAPP_URL = os.environ.get("WEBAPP_URL", "https://dapper-heliotrope-03aa40.netlify.app/mobile.html?v=7")
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if args and args[0].startswith("lobby_"):
        ...
        base_url = WEBAPP_URL.replace("/mobile.html?v=7", "").replace("/mobile.html", "")
        lobby_url = f"{base_url}/mobile.html?lobby={lobby_code}&v=7"
